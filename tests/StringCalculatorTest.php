...
class StringCalculatorTest extends TestCase
{
    ...
    public function it_finds_the_sum_of_a_single_number()
    {
        ...
        $this->assertEquals(19, $calculator->add('19'));
    }
    ...
    public function it_finds_the_sum_of_two_numbers()
    {
        ...
        $this->assertEquals(19, $calculator->add('10, 9'));
    }
    ...
    public function it_finds_the_sum_of_any_amount_of_numbers()
    {
        ...
        $this->assertEquals(33, $calculator->add('10, 9, 6, 8'));
    }
    ...
    /** @test */
    public function numbers_greater_than_MAX_NUMBER_ALLOWED_are_ignored()
    {
        $calculator = new StringCalculator;

        $this->assertEquals(10, $calculator->add("5,5,1001"));
    }

    /** @test */
    public function it_supports_a_custom_delimiters()
    {
        $calculator = new StringCalculator;
